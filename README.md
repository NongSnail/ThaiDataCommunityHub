...
Repo นี้จะรวบรวมลิงค์และข้อมูลเกี่ยวกับเพจ Facebook ที่เผยแพร่ข้อมูลสายงาน Dataที่น่าสนใจ เช่น ความรู้ทางวิทยาการข้อมูล (Data Science) และวิเคราะห์ข้อมูล (Data Analysis) หรือเทคโนโลยีที่เกี่ยวข้องกับ Data.
